    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="max-w-[400px] w-full p-10 bg-white rounded-xl shadow-md">
        ...
        <button
          ...
          disabled={isLoggingIn || authLoading || isRedirecting}
          className={`
            ...
            ${(isLoggingIn || authLoading || isRedirecting) ? "opacity-60 cursor-not-allowed bg-gray-50" : "hover:bg-gray-50 cursor-pointer"}
          `}
        >
          {(isRedirecting || (user && !authLoading)) ? (
